...
<section className="project-showcase mt-16 relative">
  ...
  <div className="flex justify-end max-w-7xl mx-auto px-6 mt-8 relative">
    <button className="bg-black text-white rounded-full p-4 shadow-lg hover:bg-gray-800 transition">
      ...
      <section className="investment-section py-16 bg-gray-50 mt-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              <h3 className="text-3xl font-bold">Looking To Make An Investment?</h3>
              <p className="text-sm text-gray-700">Connect with our Investor Relations team to learn more about current opportunities and project performance.</p>

              <form className="space-y-4 mt-4">
                <input name="name" placeholder="Name" className="w-full border border-gray-200 rounded-md px-4 py-3" />
                <input name="email" placeholder="Email" className="w-full border border-gray-200 rounded-md px-4 py-3" />
                <input name="phone" placeholder="Phone Number" className="w-full border border-gray-200 rounded-md px-4 py-3" />
                <textarea name="message" placeholder="Message" className="w-full border border-gray-200 rounded-md px-4 py-3 h-32" />

                <div className="flex justify-end">
                  <button type="submit" className="bg-red-600 text-white px-6 py-3 rounded-full flex items-center gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3 10l7-7m0 0l7 7M10 3v18" />
                    </svg>
                    Send Message
                  </button>
                </div>
