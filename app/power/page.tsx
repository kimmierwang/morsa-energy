          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
              ...
              <div className="md:col-span-2 relative">
                ...
                <button aria-label="open project" className="absolute right-6 bottom-4  w-14 h-14 bg-black text-white rounded-full flex items-center justify-center shadow-lg">
