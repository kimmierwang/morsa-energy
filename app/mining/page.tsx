        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div className="tenement-image overflow-hidden rounded-2xl shadow-lg">
              <img src="/images/img6.jpg" alt="Coal tenements and mining site" className="w-full h-[420px] md:h-[640px] lg:h-[720px] object-cover rounded-2xl" />
            </div>

            <div className="tenement-content">
